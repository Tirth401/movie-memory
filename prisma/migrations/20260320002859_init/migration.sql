...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "favoriteMovie" TEXT,
    "generatingFact" BOOLEAN NOT NULL DEFAULT false,
    "generatingFactSince" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "MovieFact_userId_movie_createdAt_idx" ON "MovieFact"("userId", "movie", "createdAt");
